...
const LaunchRequestHandler = {
    ...
    handle: async function(handlerInput) {
        ...
        return handlerInput.responseBuilder
            .speak("Welcome, you can start issuing smart bed commands")
...
const MoveIntentHandler = {
    ...
    handle: function (handlerInput) {
        ...
        /*const speechOutput = (direction === "snow")
            ?  "Clearing snow"
            : `${direction} ${duration} seconds at ${speed} percent speed`;*/
        
        var speechOutput=''
        if (direction === "snow") {
            speechOutput= "Clearing snow"
        } else if (direction === "brake" || direction==="stop") {
            speechOutput = "Stopping clear snow"
        }
...
const SetCommandIntentHandler = {
    ...
    handle: function (handlerInput) {
        ...
        const speechOutput = (command === "nurse")
            ?  "Calling nurse"
            : ``;
...
const SetClearSnowIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'SetClearSnowIntent';
    },
    handle: function (handlerInput) {
