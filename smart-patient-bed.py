...
class MindstormsGadget(AlexaGadget):
    ...
    def __init__(self):
        ...
        self.leds = Leds()
        self.sound = Sound()
        print("####Before movetank")
        #self.drive = MoveTank(OUTPUT_B, OUTPUT_C)
        print("####After movetank")
        self.bedback = MediumMotor(OUTPUT_D)
        self.tray = MediumMotor(OUTPUT_A)
    ...
    def on_custom_mindstorms_gadget_control(self, directive):
        ...
        try:
            ...
            if control_type == "move":
                print("Yes control type is move")
    ...
    def _move(self, direction, duration: int, speed: int, is_blocking=False):
        ...
        if direction in Direction.ENOUGH.value:
            print("Command is for stopping:"+direction)
            self.bedback.off()
            #self.patrol_mode = False
    ...
    def _activate(self, command, speed=50):
        ...
        '''if command in Command.CLEAR_SNOW.value:
            #self.drive.on(SpeedPercent(20), SpeedPercent(20))
            self.drive.on_for_seconds(SpeedPercent(30), SpeedPercent(30), 10, block=False)'''
